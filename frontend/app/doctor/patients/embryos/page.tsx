export default function DoctorPatientEmbryosPage() {
  return (
    <main className="min-h-screen bg-[#f7f7f5] p-10 text-[#2f2e33]">
      <div className="mx-auto max-w-3xl rounded-3xl border border-[#e5e1df] bg-white p-8 shadow-sm">
        ...
        <h1 className="mt-3 text-3xl font-bold">Patient Embryos</h1>
        <p className="mt-3 text-[#5a555d]">
          This page is ready for the embryo list for the selected patient.
        </p>
        <a
